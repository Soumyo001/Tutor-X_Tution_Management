...
class StudentProfileViewLeft extends StatefulWidget {
  const StudentProfileViewLeft({super.key});

  @override
  State<StudentProfileViewLeft> createState() => _StudentProfileViewLeftState();
}

class _StudentProfileViewLeftState extends State<StudentProfileViewLeft> {
            ...
            Row(
              ...
              children: [
                ButtonIcon(
                    ...
                    label: 'Add Post',
                    onPressed: () {
                      Get.toNamed(WebRoutes.addPostStudent);
                    },
                    enableIcon: true,
                    loading: false),
                ButtonIcon(
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Obx(
                            () => TutorProfileInfo(
                              info: _userStaticsController.studentMedium
                                  .toString()
                                  .split('.')
                                  .last
                                  .replaceAll('_', ' '),
